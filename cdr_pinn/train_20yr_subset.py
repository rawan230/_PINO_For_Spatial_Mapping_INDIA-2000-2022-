...
def main():
    ...
    def compute_rollout():
        """The expensive part (a full sequential 239-month forward pass) -- computed
    ...
    try:
        ...
        ax2.set_title("Train vs. Validation AUC\n(overfitting/underfitting diagnostic, 2001-2020 subset)")
